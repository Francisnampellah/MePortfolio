...
export function TechStack() {
  ...
  return (
    <section id="tech" className="relative z-[1] border-t border-line bg-surface">
      <div className="mx-auto max-w-page px-6 py-16">
        ...
        <div className="mt-[22px] grid grid-cols-1 gap-3.5 lg:grid-cols-[260px_1fr] lg:items-stretch">
          {/* Left — simple class selector */}
          <div className="flex flex-col gap-2">
            {TECH_GROUPS.map((g, i) => {
              ...
              const isActive = i === active;
              return (
                <Reveal key={g.name} delay={(i % 2) * 0.04}>
                  <button
                    onClick={() => setActive(i)}
          ...
          <Reveal delay={0.08} className="rounded-xl border border-line bg-white p-6 sm:p-8">
            <StatRadar
              active={active}
            ...
            <div className="mt-2 border-t border-line pt-6">
              ...
              <div key={active} className="grid grid-cols-2 gap-3 sm:grid-cols-4">
