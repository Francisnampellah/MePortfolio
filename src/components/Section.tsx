...
/** Full-page slide root: one viewport tall at md+, 32×16 gutter (horizontal × vertical). */
export const SECTION_SLIDE_ROOT =
  "relative z-[1] flex min-h-[calc(100dvh-4rem)] w-full shrink-0 scroll-mt-16 flex-col justify-center overflow-x-clip px-32 py-16 md:h-[var(--slide-h)] md:min-h-0 md:overflow-hidden";
...
export const CONTACT_SLIDE_ROOT =
  "flex min-h-[calc(100dvh-4rem)] w-full shrink-0 flex-col overflow-x-clip px-32 py-16 md:h-[var(--slide-h)] md:min-h-0 md:overflow-hidden";
